...
.node{border:2.5px solid var(--ink);padding:16px 18px;font-family:Cond;font-weight:700;font-size:24px;line-height:1.15;text-align:center;flex:0 1 auto;text-transform:uppercase;background:#fff}
